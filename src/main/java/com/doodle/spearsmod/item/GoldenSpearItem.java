...
public class GoldenSpearItem extends SpearItem {
    ...
    public GoldenSpearItem(ToolMaterial mat, int attackDamage, float attackSpeed, Settings settings) {
            ...
            if (i >= 10) {
                ...
                if (j <= 0 || playerEntity.isTouchingWaterOrRain()) {
                    if (!world.isClient) {
                        ...
                        if (j == 0) {
                            GoldenSpearEntity spearEntity = new GoldenSpearEntity(modentities.GOLDEN_SPEAR,world, playerEntity, stack);
