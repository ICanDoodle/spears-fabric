...
public class DiamondSpearItem extends SpearItem {
    ...
    public DiamondSpearItem(ToolMaterial mat, int attackDamage, float attackSpeed, Settings settings) {
            ...
            if (i >= 10) {
                ...
                if (j <= 0 || playerEntity.isTouchingWaterOrRain()) {
                    if (!world.isClient) {
                        ...
                        if (j == 0) {
                            DiamondSpearEntity spearEntity = new DiamondSpearEntity(modentities.DIAMOND_SPEAR, world, playerEntity, stack);
