...
public class WoodenSpearEntity extends SpearEntity {
    ...
    public WoodenSpearEntity(EntityType<WoodenSpearEntity> type, World world) {
        super(type, world);
        this.spearStack = new ItemStack(moditems.WOODEN_SPEAR);
    }

    public WoodenSpearEntity(EntityType<? extends SpearEntity> type, World world, LivingEntity owner, ItemStack stack) {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if (entity instanceof LivingEntity livingEntity) {
            ...
            int e = EnchantmentHelper.getLevel(modenchantments.SPIRALING, this.spearStack);
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("Wooden Spear", 10)) {
            this.spearStack = ItemStack.fromNbt(nbt.getCompound("Wooden Spear"));
        }
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        nbt.put("Wooden Spear", this.spearStack.writeNbt(new NbtCompound()));
    ...
    static {
        LOYALTY = DataTracker.registerData(WoodenSpearEntity.class, TrackedDataHandlerRegistry.BYTE);
        ENCHANTED = DataTracker.registerData(WoodenSpearEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
