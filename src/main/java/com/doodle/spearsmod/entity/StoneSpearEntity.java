...
public class StoneSpearEntity extends SpearEntity {
    ...
    public StoneSpearEntity(EntityType<StoneSpearEntity> type, World world) {
        super(type, world);
        this.spearStack = new ItemStack(moditems.STONE_SPEAR);
    }

    public StoneSpearEntity(EntityType<? extends SpearEntity> type, World world, LivingEntity owner, ItemStack stack) {
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("Stone Spear", 10)) {
            this.spearStack = ItemStack.fromNbt(nbt.getCompound("Stone Spear"));
        }
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        nbt.put("Stone Spear", this.spearStack.writeNbt(new NbtCompound()));
    ...
    static {
        LOYALTY = DataTracker.registerData(StoneSpearEntity.class, TrackedDataHandlerRegistry.BYTE);
        ENCHANTED = DataTracker.registerData(StoneSpearEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        DEFAULT_STACK = new ItemStack(moditems.STONE_SPEAR);
    }
}
