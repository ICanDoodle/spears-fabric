...
public class GoldenSpearEntity extends SpearEntity {
    ...
    public GoldenSpearEntity(EntityType<GoldenSpearEntity> type, World world) {
        super(type, world);
        this.spearStack = new ItemStack(moditems.GOLDEN_SPEAR);
    }

    public GoldenSpearEntity(EntityType<? extends SpearEntity> type, World world, LivingEntity owner, ItemStack stack) {
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("Golden Spear", 10)) {
            this.spearStack = ItemStack.fromNbt(nbt.getCompound("Golden Spear"));
        }
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        nbt.put("Golden Spear", this.spearStack.writeNbt(new NbtCompound()));
    ...
    static {
        LOYALTY = DataTracker.registerData(GoldenSpearEntity.class, TrackedDataHandlerRegistry.BYTE);
        ENCHANTED = DataTracker.registerData(GoldenSpearEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        DEFAULT_STACK = new ItemStack(moditems.GOLDEN_SPEAR);
    }
}
