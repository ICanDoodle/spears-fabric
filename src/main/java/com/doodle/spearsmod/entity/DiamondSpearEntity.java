...
public class DiamondSpearEntity extends SpearEntity {
    ...
    public DiamondSpearEntity(EntityType<? extends DiamondSpearEntity> type, World world) {
        super(type, world);
        this.spearStack = new ItemStack(moditems.DIAMOND_SPEAR);
    }

    public DiamondSpearEntity( EntityType<? extends SpearEntity> type, World world, LivingEntity owner, ItemStack stack) {
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("Diamond Spear", 10)) {
            this.spearStack = ItemStack.fromNbt(nbt.getCompound("Diamond Spear"));
        }
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        nbt.put("Diamond Spear", this.spearStack.writeNbt(new NbtCompound()));
    ...
    static {
        LOYALTY = DataTracker.registerData(DiamondSpearEntity.class, TrackedDataHandlerRegistry.BYTE);
        ENCHANTED = DataTracker.registerData(DiamondSpearEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        DEFAULT_STACK = new ItemStack(moditems.DIAMOND_SPEAR);
    }
}
