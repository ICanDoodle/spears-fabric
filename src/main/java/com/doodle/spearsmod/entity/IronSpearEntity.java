...
public class IronSpearEntity extends SpearEntity {
    ...
    public IronSpearEntity(EntityType<IronSpearEntity> type, World world) {
        super(type, world);
    }

    public IronSpearEntity(EntityType<? extends SpearEntity> type, World world, LivingEntity owner, ItemStack stack) {
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("Iron Spear", 10)) {
            this.spearStack = ItemStack.fromNbt(nbt.getCompound("Iron Spear"));
        }
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        nbt.put("Iron Spear", this.spearStack.writeNbt(new NbtCompound()));
    ...
    static {
        LOYALTY = DataTracker.registerData(IronSpearEntity.class, TrackedDataHandlerRegistry.BYTE);
        ENCHANTED = DataTracker.registerData(IronSpearEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        DEFAULT_STACK = new ItemStack(moditems.IRON_SPEAR);
    }
}
